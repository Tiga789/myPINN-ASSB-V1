...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Evaluate ASSBfinal1 physics-only PINN on soft-label test splits.")
    ...
    p.add_argument("--output-prefix", default="eval_ASSBfinal1")
...
def build_model(repo_root: str, model_dir: str, ckpt_path: str, profile_path: str, profile_encoding: str,
                profile_cycle_start: Optional[int], profile_cycle_end: Optional[int]):
...
def main() -> None:
    ...
    nn, _config = build_model(
        args.repo_root,
        model_dir,
        ckpt,
        args.profile_path,
        args.profile_encoding,
        args.profile_cycle_start,
        args.profile_cycle_end,
    )
